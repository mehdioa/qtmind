	...
	ui(new Ui::MainWindow)
{
	...
	{
		pegsNumberComboBox->addItem(QString("%1 %2").arg(boardAid.locale.toString(i), tr("Slots")));
	}
	...
	{
		colorsNumberComboBox->addItem(QString("%1 %2").arg(boardAid.locale.toString(i), tr("Colors")));
	}
...
void MainWindow::resetActionsText()
{
	...
	for(int i = MIN_SLOT_NUMBER; i <= MAX_SLOT_NUMBER; ++i)
	{
		pegsNumberComboBox->setItemText(i - MIN_SLOT_NUMBER, QString("%1 %2").arg(boardAid.locale.toString(i), tr("Slots")));
	}
	pegsNumberComboBox->setToolTip(tr("Choose the numbe of slots"));

	for(int i = MIN_COLOR_NUMBER; i <= MAX_COLOR_NUMBER; ++i)
	{
		colorsNumberComboBox->setItemText(i - MIN_COLOR_NUMBER, QString("%1 %2").arg(boardAid.locale.toString(i), tr("Colors")));
	}
	colorsNumberComboBox->setToolTip(tr("Choose the number of colors"));
